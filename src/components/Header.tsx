...
export default function Header() {
	...
	return (
		<header className="sticky top-0 border border-b-gray-200 p-4 flex flex-row justify-end align-baseline gap-8">
			{
			...
			}
			{
				isAuthenticated
					? <button
						...
						className='border border-gray-400 rounded-sm px-2 py-1 cursor-pointer bg-transparent hover:bg-gray-200 transition-all duration-300'
					>
						<span>Logout</span>
					</button>
					: null
